...
>	- Removing a federation doesn't remove the users & groups so we want to tidy them up (note that this nukes all users & groups, not federation specific). Although at this point it might be worth just exporting the realm without users & groups, deleting the realm, and reimporting and resyncing?
