...
COPY --chown=quartz:quartz ["content/🧠 Knowledge/⚙️ Sysadmin & Networking", "content/Knowledge/Sysadmin & Networking"]
...
COPY --chown=quartz:quartz ["content/🧠 Knowledge/🖥️ OS Internals", "content/Knowledge/OS Internals"]
